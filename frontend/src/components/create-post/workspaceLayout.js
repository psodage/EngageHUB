...
export const WORKSPACE_COMPOSER_COLUMN =
  "flex min-h-0 flex-1 flex-col overflow-hidden border-r border-slate-200 dark:border-slate-700";
...
export const WORKSPACE_PREVIEW_ASIDE =
  "flex min-h-0 flex-1 flex-col overflow-hidden bg-[#f4f5f7] px-4 py-3 dark:bg-slate-950/60";
